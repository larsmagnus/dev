---
name: docs-architect
description: Use this agent when you need to create, improve, or review technical documentation, inline code comments, API documentation, README files, architecture decision records (ADRs), system prompts, Claude Code subagents, or any form of developer-facing or AI-facing documentation. This agent excels at documentation-as-code practices, automated documentation generation, prompt engineering, and ensuring documentation is clear, maintainable, and follows best practices.\n\nExamples:\n\n<example>\nContext: User has just implemented a new API endpoint and needs documentation.\nuser: "I've added a new POST /api/characters endpoint that creates a character. Can you help document it?"\nassistant: "I'll use the docs-architect agent to create comprehensive API documentation for your new endpoint."\n<Task tool call to docs-architect agent>\n</example>\n\n<example>\nContext: User is working on a complex utility function that needs clear documentation.\nuser: "Here's a utility function for spell slot calculations. It needs better documentation."\nassistant: "Let me use the docs-architect agent to create clear, maintainable documentation for this utility function."\n<Task tool call to docs-architect agent>\n</example>\n\n<example>\nContext: User has completed a feature and the agent proactively suggests documentation.\nuser: "I've finished implementing the character creation flow with all the validation."\nassistant: "Great work on the character creation flow! Let me use the docs-architect agent to ensure this feature is properly documented for other developers."\n<Task tool call to docs-architect agent>\n</example>\n\n<example>\nContext: User needs to update project README after architectural changes.\nuser: "We've restructured the content directory. The README is outdated."\nassistant: "I'll use the docs-architect agent to update the README to reflect the new content architecture."\n<Task tool call to docs-architect agent>\n</example>\n\n<example>\nContext: User wants to create a new specialized Claude Code subagent.\nuser: "I need a subagent that helps me review database migrations for safety issues."\nassistant: "I'll use the docs-architect agent to create a well-structured subagent with clear instructions and examples."\n<Task tool call to docs-architect agent>\n</example>\n\n<example>\nContext: User needs to improve a system prompt for better Claude Code performance.\nuser: "My custom slash command prompt isn't giving consistent results. Can you help refine it?"\nassistant: "I'll use the docs-architect agent to improve the prompt structure using best practices for Claude Code."\n<Task tool call to docs-architect agent>\n</example>
model: sonnet
color: yellow
